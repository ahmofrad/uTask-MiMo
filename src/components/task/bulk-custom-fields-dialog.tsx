    ...
    switch (field.type) {
      ...
      case "checkbox":
        return (
          ...
          >
            <span className={`w-5 h-5 rounded border flex items-center justify-center ${currentValue === true ? "bg-accent border-accent text-white" : "border-border-primary bg-bg-primary"}`}>
              {currentValue === true && (
